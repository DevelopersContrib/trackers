<div class="form-group row">
						...
						<div class="form-group row d-none" id="fromApiContent">
							<label for="" class="col-sm-2 col-form-label text-right">API Key</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="current_api_key" id="current_api_key" value="" readonly/>
							</div>
						</div>
						
						
						<div class="form-group row" id="fromApiContent">
							<label for="" class="col-sm-2 col-form-label text-right" id="labelApi">API Key</label>
							<div class="col-md-10" id="genApiBtn">
