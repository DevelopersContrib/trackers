<?php
class CampaignData extends CI_Model {
	private $table = "tracker_campaigns";
	private $pk = "id";
	private $date = null;
  ...
  function update($id,$data){
	...
	function getallbyuser($userid){
	  		return  $this->db->query("SELECT * FROM $this->table where member_id = '$userid' order by campaign_name");
	}
 }